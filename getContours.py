...
def getShowContours(imageFile):
    """
    helper method to combine the finding of contours and their visual representation
    :param imageFile: filepath to a png file (probably even other image formats are supported)
    :return: image, contours, hierarchy
    """
...
def getShowContoursAll():
    """
    For all known sources, show the calculated contours
    :return:
    """
